...
Run this using 
    ...
    $ fontbakery check-profile tests/fbchecks.py <ttf file(s) to check> --html <name of file for html results>
eg
    $ fontbakery check-profile tests/fbchecks.py results/*.ttf --html results/Andika-Mtihani-fontbakery-ttfcheck-report.html
