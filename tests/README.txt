...
running manually on UFO sources from the root of the project folder:
fontbakery check-profile tests/ufocheck.py source/*.ufo --html results/Andika-Mtihani-fontbakery-ufocheck-report.html
